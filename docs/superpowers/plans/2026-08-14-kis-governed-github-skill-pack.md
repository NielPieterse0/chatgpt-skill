...
- [ ] Close the capability-discovery split-brain: kis-mcp #183 tracks stale ready contributions for absent skills that remain visible through `search_capabilities`.
