...
The skills-only package starts no background process and opens no listening port.
All operations use explicit CLI commands against workspaces created by an
